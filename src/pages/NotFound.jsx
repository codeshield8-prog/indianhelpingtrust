...
export default function NotFound() {
  return (
    <>
      <Seo
        title="Page Not Found | Indian Helping Trust"
        description="The page you’re looking for doesn’t exist or has moved. Return to the Indian Helping Trust homepage."
        path="/404"
        noindex
      />
